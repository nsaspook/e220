...
$(document).ready(function () {
    ...
    $("#editorial-vid").click(function () {
        ...
        homeVidTemplate = "<!-- Start of Brightcove Player -->" + "<div style=\"display:none\">" + "</div>" + "<object id=\"myExperience\" class=\"BrightcoveExperience\">" + "<param name=\"bgcolor\" value=\"#FFFFFF\" />" + "<param name=\"width\" value=\"" + elemWidth + "\" />" + "<param name=\"height\" value=\"" + elemHeight + "\" />" + "<param name=\"playerID\" value=\"1821598786001\" />" + "<param name=\"playerKey\" value=\"AQ~~,AAABpcur3jE~,ShoUMJBK2TmpJwDSaiJJhT6D9H6oZ9QJ\" />" + "<param name=\"isVid\" value=\"true\" />" + "<param name=\"isUI\" value=\"true\" />" + "<param name=\"dynamicStreaming\" value=\"true\" />" + "<param name=\"wmode\" value=\"tranparent\" />" + "</object>" + "<!-- End of Brightcove Player -->";
        $(".video-feed").html(homeVidTemplate);
    ...
    $("#sponsored-vid").click(function () {
        ...
        homeVidTemplate = "<!-- Start of Brightcove Player -->" + "<div style=\"display:none\">" + "</div>" + "<object id=\"myExperience\" class=\"BrightcoveExperience\">" + "<param name=\"bgcolor\" value=\"#FFFFFF\" />" + "<param name=\"width\" value=\"" + elemWidth + "\" />" + "<param name=\"height\" value=\"" + elemHeight + "\" />" + "<param name=\"playerID\" value=\"1821598787001\" />" + "<param name=\"playerKey\" value=\"AQ~~,AAABpcur3jE~,ShoUMJBK2Tk08XnZ4zfH6w4RjHl2Ewge\" />" + "<param name=\"isVid\" value=\"true\" />" + "<param name=\"isUI\" value=\"true\" />" + "<param name=\"dynamicStreaming\" value=\"true\" />" + "<param name=\"wmode\" value=\"tranparent\" />" + "</object>" + "<!-- End of Brightcove Player -->";
        $(".video-feed").html(homeVidTemplate);
        return brightcove.createExperiences();
    });
    //google plus launch
