    ...
    $(function () {
        ...
        */
        ...
        if (Modernizr.mq('only screen and (max-width: 767px)')) {
            ...
            if (currPage !== "insights-landing") {
                if (currPage === "home-landing") {
                    loadVidTemplate(724, 324, "home");
                } else {
                    loadVidTemplate(724, 324);
                }
            }
            if (currPage === "insights-landing") {
...
//    };
    ...
    loadVidTemplate = function (elemWidth, elemHeight, pageType) {
        var homeVidTemplate, vidTemplate;
        if (elemWidth == null) {
            elemWidth = 573;
        }
        if (elemHeight == null) {
