...
${OBJECTDIR}/crc8_fast.o: crc8_fast.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -p$(MP_PROCESSOR_OPTION) --verbose -ml --extended -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/crc8_fast.o   crc8_fast.c 
...
${OBJECTDIR}/crc8_fast.o: crc8_fast.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/crc8_fast.o.d 
	@${RM} ${OBJECTDIR}/crc8_fast.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) --verbose -ml --extended -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/crc8_fast.o   crc8_fast.c 
	@${DEP_GEN} -d ${OBJECTDIR}/crc8_fast.o 
	@${FIXDEPS} "${OBJECTDIR}/crc8_fast.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
