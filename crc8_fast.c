...
#if defined(__18CXX)
const rom uint8_t crc8_table[256] =
#else
...
#if defined(__18CXX)
const rom uint16_t crc16tab[256] =
#else
...
uint8_t crc8_calculate(uint8_t* buf, uint16_t size)
{
	uint16_t i = 0;
	uint8_t crc = 0;
...
/* On entry, addr=>start of data
	     num = length of data
	     crc = incoming CRC     */
uint16_t crc16(uint8_t* addr, uint16_t num, uint16_t crc) // XMODEM crc-16
{
	int16_t i;
